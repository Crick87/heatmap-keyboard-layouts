...
export class AppComponent {
  ...
  keyboards = [
    ...
    {
      name: 'QFMLWY',
      keys: ['Q', 'F', 'M', 'L', 'W', 'Y', 'U', 'O', 'B', 'J', 'D', 'S', 'T', 'N', 'R',
             'I', 'A', 'E', 'H', 'Ñ', 'Z', 'V', 'G', 'C', 'X', 'P', 'K', ',', '.', '-']
    },
    {
      name: 'QGMLWB',
      keys: ['Q', 'G', 'M', 'L', 'W', 'B', 'Y', 'U', 'V', 'Ñ', 'D', 'S', 'T', 'N', 'R',
             'I', 'A', 'E', 'O', 'H', 'Z', 'X', 'C', 'F', 'J', 'K', 'P', ',', '.', '-']
    },
    {
      name: 'QGMLWY',
      keys: ['Q', 'G', 'M', 'L', 'W', 'Y', 'F', 'U', 'B', 'Ñ', 'D', 'S', 'T', 'N', 'R',
             'I', 'A', 'E', 'O', 'H', 'Z', 'X', 'C', 'V', 'J', 'K', 'P', ',', '.', '-']
    },
    {
      name: 'norman',
